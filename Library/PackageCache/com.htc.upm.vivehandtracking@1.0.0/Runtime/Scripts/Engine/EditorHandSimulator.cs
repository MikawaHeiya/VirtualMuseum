...
class EditorHandSimulator : MonoBehaviour {
  ...
  public GestureResultRaw LeftHand {
    get { return LeftState.preset == HandSimulationPreset.Invisible ? null : leftHand; }
  }
  private GestureResultRaw leftHand;

  public GestureResultRaw RightHand {
    get { return RightState.preset == HandSimulationPreset.Invisible ? null : rightHand; }
  }
  ...
  void SetHand(HandSimulationState state, GestureResultRaw hand) {
    if (state.preset == HandSimulationPreset.Invisible) return;
  ...
  static EditorHandSimulator() {
    ...
    ThumbMap[FingerSimulationState.Close] = new Vector3[] {
      new Vector3(-0.02561346f, 0.02549528f, 0f),
      new Vector3(-0.03271355f, 0.05344393f, 0.02630469f),
      new Vector3(-0.03909954f, 0.07858165f, 0.0499638f),
      new Vector3(-0.01853538f, 0.09150755f, 0.0621646f),
    };
    ThumbMap[FingerSimulationState.Open] = new Vector3[] {
      new Vector3(-0.02561346f, 0.02549528f, 0f),
      new Vector3(-0.05091827f, 0.055213f, 0f),
      new Vector3(-0.07367802f, 0.08194186f, 0f),
      new Vector3(-0.08944285f, 0.1004559f, 0f),
    };
    ThumbMap[FingerSimulationState.Pinch] = new Vector3[] {
      new Vector3(-0.02561346f, 0.02549528f, 0f),
      new Vector3(-0.03026959f, 0.0487665f, 0.03098783f),
      new Vector3(-0.03445743f, 0.06969722f, 0.05885908f),
      new Vector3(-0.03735819f, 0.08419512f, 0.07816443f),
    };
    ...
    IndexMap[FingerSimulationState.Close] = new Vector3[] {
      new Vector3(-0.0234468f, 0.08993375f, 0f),
      new Vector3(-0.03007099f, 0.09965698f, 0.03628755f),
      new Vector3(-0.03120193f, 0.07783888f, 0.04877388f),
      new Vector3(-0.0279232f, 0.0624964f, 0.03363425f),
    };
    IndexMap[FingerSimulationState.Open] = new Vector3[] {
      new Vector3(-0.0234468f, 0.08993375f, 0f),
      new Vector3(-0.03007099f, 0.1275014f, 0f),
      new Vector3(-0.03444064f, 0.1522829f, 0f),
      new Vector3(-0.0382266f, 0.1737542f, 0f),
    };
    IndexMap[FingerSimulationState.Relax] = new Vector3[] {
      new Vector3(-0.0234468f, 0.08993375f, 0f),
      new Vector3(-0.03007099f, 0.1224683f, 0.01878384f),
      new Vector3(-0.03385521f, 0.1347634f, 0.04041079f),
      new Vector3(-0.0357482f, 0.13462f, 0.06213051f),
    };
    IndexMap[FingerSimulationState.Pinch] = new Vector3[] {
      new Vector3(-0.0234468f, 0.08993375f, 0f),
      new Vector3(-0.03007099f, 0.1058105f, 0.03404784f),
      new Vector3(-0.03377666f, 0.1026068f, 0.05873024f),
      new Vector3(-0.03610754f, 0.09262248f, 0.07797164f),
    };

    MiddleMap = new Dictionary<FingerSimulationState, Vector3[]>();
    MiddleMap[FingerSimulationState.Close] = new Vector3[] {
      new Vector3(0f, 0.09059203f, 0f),
      new Vector3(0.002243221f, 0.1016704f, 0.04134488f),
      new Vector3(0.002620131f, 0.07757138f, 0.05524743f),
      new Vector3(0.00155279f, 0.06092726f, 0.03862306f),
    };
    MiddleMap[FingerSimulationState.Open] = new Vector3[] {
      new Vector3(0f, 0.09059203f, 0f),
      new Vector3(0.002243221f, 0.1333954f, 0f),
      new Vector3(0.003699422f, 0.1611814f, 0f),
      new Vector3(0.004931867f, 0.1846977f, 0f),
    };
    MiddleMap[FingerSimulationState.Relax] = new Vector3[] {
      new Vector3(0f, 0.09059203f, 0f),
      new Vector3(0.002243221f, 0.1276608f, 0.02140167f),
      new Vector3(0.003504336f, 0.1415443f, 0.04548159f),
      new Vector3(0.004120559f, 0.1415303f, 0.06902212f),
    };
    ...
    RingMap[FingerSimulationState.Close] = new Vector3[] {
      new Vector3(0.01830575f, 0.08586f, 0f),
      new Vector3(0.02556321f, 0.09651273f, 0.03975654f),
      new Vector3(0.02667755f, 0.07501508f, 0.05205947f),
      new Vector3(0.02360314f, 0.06062887f, 0.03786346f),
    };
    RingMap[FingerSimulationState.Open] = new Vector3[] {
      new Vector3(0.01830575f, 0.08586f, 0f),
      new Vector3(0.02556321f, 0.127019f, 0f),
      new Vector3(0.02986869f, 0.1514365f, 0f),
      new Vector3(0.03341869f, 0.1715696f, 0f),
    };
    RingMap[FingerSimulationState.Relax] = new Vector3[] {
      new Vector3(0.01830575f, 0.08586f, 0f),
      new Vector3(0.02556321f, 0.1215047f, 0.02057949f),
      new Vector3(0.02929184f, 0.1336193f, 0.0418888f),
      new Vector3(0.03106686f, 0.1334848f, 0.06225482f),
    };
    ...
    PinkyMap[FingerSimulationState.Close] = new Vector3[] {
      new Vector3(0.03541002f, 0.07745709f, 0f),
      new Vector3(0.04617861f, 0.08511462f, 0.02857831f),
      new Vector3(0.04784632f, 0.06872287f, 0.03771409f),
      new Vector3(0.04305059f, 0.05749299f, 0.02708218f),
    };
    PinkyMap[FingerSimulationState.Open] = new Vector3[] {
      new Vector3(0.03541002f, 0.07745709f, 0f),
      new Vector3(0.04617861f, 0.1070435f, 0f),
      new Vector3(0.05262217f, 0.124747f, 0f),
      new Vector3(0.0581598f, 0.1399616f, 0f),
    };
    PinkyMap[FingerSimulationState.Relax] = new Vector3[] {
      new Vector3(0.03541002f, 0.07745709f, 0f),
      new Vector3(0.04617861f, 0.1030797f, 0.01479322f),
      new Vector3(0.05175889f, 0.1116474f, 0.03061688f),
      new Vector3(0.0545277f, 0.1112246f, 0.04656374f),
    };
...
class EditorHandSimulatorEditor : Editor {
  ...
  private static readonly FingerSimulationState[] ThumbStates =
      new FingerSimulationState[] { FingerSimulationState.Close, FingerSimulationState.Open,
                                    FingerSimulationState.Pinch };
  private static readonly string[] IndexStateNames =
      new string[] { "Close", "Open", "Relax", "Pinch" };
  ...
  void DrawState(SerializedProperty prop, ref bool expand, string name) {
    ...
    EditorGUILayout.PropertyField(prop.FindPropertyRelative("confidence"),
                                  new GUIContent(name + " Confidence"));
    ...
    if (EditorGUILayout.BeginFadeGroup(expand ? 1 : 0)) {
      ...
      if (changed) ApplyPreset(prop, (HandSimulationPreset)newValue);
      ...
      if (hasSkeleton) {
        ...
        GUI.enabled = true;
        if (changed) CalculatePreset(prop, presetProp);
      }
      EditorGUI.indentLevel--;
    }
  ...
  bool DrawFinger(SerializedProperty prop, string[] stateNames,
                  FingerSimulationState[] states = null) {
    EditorGUILayout.BeginHorizontal();
    var name = char.ToUpper(prop.name[0]) + prop.name.Substring(1) + " State";
    EditorGUILayout.PrefixLabel(name);
    int value = prop.intValue;
    if (states != null) value = Array.IndexOf(states, (FingerSimulationState)(value));
    value = GUILayout.Toolbar(value, stateNames);
    if (states != null) value = (int)states[value];
    EditorGUILayout.EndHorizontal();
  ...
  void CalculatePreset(SerializedProperty prop, SerializedProperty presetProp) {
    ...
    } else if (thumb == FingerSimulationState.Close && middle == index && thumb == ring &&
               thumb == pinky) {
    ...
    } else if (thumb == FingerSimulationState.Open && index == middle && index == ring &&
               index == pinky) {
    ...
    if (index == FingerSimulationState.Open && middle == FingerSimulationState.Close &&
